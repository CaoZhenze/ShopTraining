$(function(){
    ...
    (function(){
        var oDiv = $('.update');
        var oUI = oDiv.find('ul');
        var arrData = [
            {'name':'萱萱', 'time':5, 'title':'那些灿烂华美的瞬间', 'url':'http://www.miaov.com/2013/'},
            {'name':'畅畅', 'time':6, 'title':'广东三天抓获傻逼', 'url':'http://www.miaov.com/2013/'},
            {'name':'萱萱', 'time':7, 'title':'那些灿烂华美的瞬间', 'url':'http://www.miaov.com/2013/'},
            {'name':'畅畅', 'time':8, 'title':'那些灿烂华美的瞬间', 'url':'http://www.miaov.com/2013/'},
            {'name':'萱萱', 'time':9, 'title':'那些灿烂华美的瞬间', 'url':'http://www.miaov.com/2013/'},
            {'name':'畅畅', 'time':10, 'title':'那些灿烂华美的瞬间', 'url':'http://www.miaov.com/2013/'},
            {'name':'萱萱', 'time':11, 'title':'那些灿烂华美的瞬间', 'url':'http://www.miaov.com/2013/'},
            {'name':'畅畅', 'time':12, 'title':'那些灿烂华美的瞬间', 'url':'http://www.miaov.com/2013/'},
        ]
        var str = '';
